<div>
    <div class="p-4 sm:p-6 lg:p-8">
        ...
        <div class="mb-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <x-secondary-button
                        x-data=""
                        x-on:click.prevent="$dispatch('open-modal', 'bulk-upload-products')"
        ...
        {{-- Supplier Filter Badge (if active) --}}
            ...
            <div class="mb-4">
                <div class="inline-flex items-center px-4 py-2 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg">
                    ...
                    <span class="text-sm font-medium text-purple-900 dark:text-purple-200">
                        Filtered by supplier: <span class="font-semibold">{{ $filteredSupplierName }}</span>
                    </span>
                    <button
                        wire:click="clearSupplierFilter"
                        class="ml-3 text-purple-600 dark:text-purple-400 hover:text-purple-800 dark:hover:text-purple-300"
                    >

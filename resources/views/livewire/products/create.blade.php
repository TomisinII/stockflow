<x-modal name="create-product" maxWidth="3xl" :show="false">
    <form wire:submit="save">
        ...
        <div class="px-6 py-4 max-h-[70vh] overflow-y-auto">
            <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            ...
                            <button
                                ...
                                class="px-3 py-2 bg-gray-100 dark:bg-gray-600 text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-500 text-sm font-medium whitespace-nowrap"
                            >
                                Auto
                            </button>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <label for="current_stock" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    ...
                    <div>
                        <label for="minimum_stock" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    ...
                    <div>
                        <label for="maximum_stock" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Maximum Stock</label>
                        <input
                            type="number"
                            id="maximum_stock"
                    ...
                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-lg hover:border-gray-400 dark:hover:border-gray-500 transition-colors">
                        <div class="space-y-1 text-center">
                            ...
                            <div class="flex text-sm text-gray-600 dark:text-gray-400">
                                <label for="image" class="relative cursor-pointer bg-white dark:bg-gray-800 rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none">
        ...
        <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700/50 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-3">
            ...
            <x-primary-button type="submit" class="!py-2 !px-6 !w-auto">
                Save Product
            </x-primary-button>
        </div>
    </form>
